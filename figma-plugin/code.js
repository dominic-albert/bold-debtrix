...
async function getUXDebts(projectId) {
    if (!apiKey || !config) {
        figma.ui.postMessage({
...
async function createUXDebt(projectId, debtData) {
    if (!apiKey || !userData || !config) {
        figma.ui.postMessage({
...
async function updateUXDebt(projectId, debtId, debtData) {
    if (!apiKey || !userData || !config) {
        figma.ui.postMessage({
...
async function deleteUXDebt(projectId, debtId) {
    if (!apiKey || !config) {
        figma.ui.postMessage({
