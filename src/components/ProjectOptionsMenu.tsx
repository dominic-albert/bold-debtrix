...
function ProjectOptionsMenu({ project, onEdit }: ProjectOptionsMenuProps) {
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
          <div className="bg-white rounded-xl shadow-xl w-full max-w-md p-6">
            ...
            <p className="text-gray-600 mb-6">
              Are you sure you want to delete "{project.title}"? This action cannot be undone and will permanently delete all UX debts in this project.
            </p>
